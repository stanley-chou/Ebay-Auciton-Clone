...
<body style = "background-color: lightblue;">
		...
		try {
			...
			ResultSet result = stmt.executeQuery("SELECT B.BidID, B.priceBid, V.VehicleID, V.CustomerID, V.modelYear, V.modelMake, V.modelName, B.upperLimit, V.date as list_date, B.time_left as bid_date"
					+ " FROM vehicle_sells V, bid B" 
					+ " WHERE V.VehicleID = B.VehicleID AND V.VehicleID = " + history + ";");
			...
			while (result.next()) {
				...
				out.print("<td>"); 		
					...
					out.print("<td>"); 		
						out.print(result.getString("priceBid"));
					out.print("</td>");	
				//make a column
					out.print("<td>");
