...
<html>
	...
	<body>
		...
		try {
			...
			String str = "SELECT V.VehicleID, V.CustomerID, V.modelYear, V.modelMake, V.modelName, MAX(B.priceBid) as 'CurrentBid', B.upperLimit, V.date as list_date, B.time_left as bid_date" 
			+ " FROM " + "vehicle_sells V, bid B" + " WHERE " + "V.VehicleID = B.VehicleID" + " GROUP BY " + " V.VehicleID" 
			+ " ORDER BY " + " B.upperLimit";
