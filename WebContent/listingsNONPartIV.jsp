...
<html>
	...
	<body>
		...
		try {
			...
			String str = "SELECT V.VehicleID, V.CustomerID, V.modelYear, V.modelMake, V.modelName, V.date as list_date, V.initial_price, V.seller_increment" 
			+ " FROM " + "vehicle_sells V;";
	...
	//		out.print("</td>");
			...
			out.print("<td>");
			out.print("Initial Item Price");
			out.print("</td>");
			
			out.print("<td>");
			out.print("Seller Bid Increment");
			out.print("</td>");
		...
		//			out.print("</td>");
					...
					out.print("</td>");
						out.print("<td>"); out.print(result.getString("initial_price"));
					out.print("</td>");
						out.print("<td>"); out.print(result.getString("seller_increment"));
					out.print("</td>");
