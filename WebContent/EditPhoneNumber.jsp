...
try {
	...
	String phonenmbr = request.getParameter("phonenumber");
	
	stmt.executeUpdate("UPDATE customer SET phoneNum = \""+phonenmbr+"\" WHERE UserId="+userID+";");
	
	out.println("<center>Successfully Updated the Phone Number!</center>");
