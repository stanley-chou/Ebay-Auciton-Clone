...
try {
	...
	stmt.executeUpdate("Delete from customer WHERE UserId="+userID+";");
	
	out.println("<center>Successfully Deleted Account with Username "+userID+" !</center>");
	...
	out.println(e);
	out.println("<center>Failed to delete account! </center>");
	out.println("<br>");
	out.println("<center><p> <a href=\"logout.jsp\"  style=\"position: absolute; top: 0; right: 0; width: 100px; text-align:right;\" >Logout</a>. </p> </center>");
