...
<body style = "background-color: lightblue;">
		...
		try {
			...
			String pAB = request.getParameter("pAB");
			...
			+ " FROM " + "vehicle_sells V, bid B, (SELECT MAX(B.priceBID) AS 'CurrentBid', V.VehicleID FROM bid B, vehicle_sells V WHERE V.VehicleID = B.VehicleID Group BY V.VehicleID) AS t1" 
			+ " WHERE " + "V.VehicleID = B.VehicleID AND t1.VehicleID = V.VehicleID AND t1.VehicleID = B.VehicleID AND t1.CurrentBid <= " + pAB
